    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Add Category in Existing Class
                </h1>
                <ol class="breadcrumb">
          ...
          ";
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="myprofile">
                            <form method="POST" action="addcategory_data.php" name="addcategory">
                                ...
                                <button type="submit" class="btn btn-success btn-flat" name="addcategory"><i class="fa fa-check-square-o"></i> Add Category</button>
                            </form>
                        </div>
                    </div>
                </div>
